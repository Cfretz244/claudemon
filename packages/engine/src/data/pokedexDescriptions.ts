export const POKEDEX_DESCRIPTIONS: Record<number, string> = {
  ...
  13: "Often found in forests, eating leaves. It has a sharp venomous stinger on top of its head.",
  14: "Almost incapable of moving, this POKeMON can only harden its shell to protect itself from predators.",
  15: "Flies at high speed and attacks using its large venomous stingers on its forelegs.",
  ...
  24: "The frightening patterns on its belly have been studied. Six distinct variations have been confirmed.",
  ...
  41: "Forms colonies in perpetually dark places. Uses ultrasonic cries for echolocation.",
  ...
  47: "A host-Loss parasite duo in which the weights of the host and the parasite have been reversed.",
  ...
  58: "Very friendly and faithful to people. It will try to intimidate larger opponents by barking.",
  ...
  62: "An excellent swimmer at both the front crawl and breaststroke. Easily overtakes the best human swimmers.",
  ...
  65: "Its brain can outperform a super-computer. Its intelligence quotient is said to be 5,000.",
  ...
  82: "Formed by two MAGNEMITEs linked together. They frequently appear when sunspots flare up.",
  ...
  131: "A POKeMON that has been overhunted almost to extinction. It can ferry people across the water.",
  ...
  142: "A ferocious, prehistoric POKeMON that goes for the enemy's throat with its serrated saw-like fangs.",
